...
namespace WebApi.Controllers
{
    ...
    public sealed class AdminController(IMediator mediator) : ControllerBase
    {
        ...
        {
            var result = await mediator.Send(new GetAttributeDefinitionsPagedQuery(page, pageSize), ct);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> UpdateAttribute(
            Guid id,
            [FromBody] UpdateAttributeDefinitionCommand body,
            CancellationToken ct)
        {
        ...
        {
            await mediator.Send(new DeleteAttributeDefinitionCommand(id), ct);
            return NoContent();
        }
        ...
        {
            var result = await mediator.Send(new GetCategoriesPagedQuery(page, pageSize), ct);
            return Ok(result);
        }
        ...
        {
            var result = await mediator.Send(new GetBrandsPagedQuery(page, pageSize), ct);
            return Ok(result);
        }
